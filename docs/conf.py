...
project = "choppa"
copyright = (
    "2024, Jenke Scheen. Project structure based on the "
...
latex_documents = [
    (master_doc, "choppa.tex", "choppa Documentation", "choppa", "manual"),
]
...
man_pages = [(master_doc, "choppa", "choppa Documentation", [author], 1)]
